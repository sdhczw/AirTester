...
void SimpleBLEPeripheral_Init( uint8 task_id )
{
  ...
  // is halted ÔÚMCU¿ÕÏÐµÄÊ±ºò½µµÍÖ÷ÆµÀ´½µµÍ¹¦ºÄ£¬µ«ÊÇ»áÓ°Ïìµ½DMA¿ØÖÆÆ÷°áÊý¾Ý
...
{  
    ...
    if(!HAL_PUSH_BUTTON2())//¼ì²âÒý½ÅÈç¹ûÎª0£¬ÔòÈÏÎªÓÃ»§¶Ï¿ª³äµçÏß£¬¶Ï¿ª³äµçÒý½Å
    {
        //The I2C configuration and state is not retained in power modes PM2 and PM3. It must be reconfigured after coming out of sleep mode
    ...
    else//Èç¹û¼ì²âÒý½ÅÈç¹ûÎª1£¬ÔòÈÏÎªÓÃ»§¼ÌÐø³äµç£¬¼ÌÐø¼ì²â
    {
